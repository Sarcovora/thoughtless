...
const RubricRatings = ({ feedback, questionId, applicant, ratings, setRatings, comments, setComments }) => {
    ...
    let globalComments = comments;

    // let ratings = feedback.feedback_array;
    // let comments = feedback.comments_array;
    ...
    const handleCommentsChange = (e) => {
        ...
        // const newComments = [...globalComments]; // Create a copy of the comments array
        // console.log(newComments)
        newComments[questionId] = e.target.value; // Update the value for the specific questionId
        // globalComments = newComments
        setComments(newComments); // Update the state
        comments[questionId] = e.target.value;
        // console.log("COMMMNETS", comments)
        // updateFeedback();
    };
    ...
    return (
        <>
            ...
            <Textarea
                ...
                // onChange={(value) => {
                //     comments[questionId] = value.target.value;
